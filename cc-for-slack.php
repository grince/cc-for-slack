...
# https://hooks.slack.com/services/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
...
$user_agent = "CC-for-Slack/1.0 (https://github.com/grince/cc-for-slack; rince@cccs.de)";
...
$url_to_check = "http://api.coindesk.com/v1/bpi/currentprice.json";
...
if($ch_response === FALSE){
  # bitcoin-exchange could not be reached 
  $reply = "Ironically, bitcoin-exchange could not be reached.";
}else{
  if($response_array["bpi"]["EUR"]["rate"] != 0){
  	# Yay, the domain is up! 
    $reply = ":thumbsup: the exchange rate is currrently ".$response_array["bpi"]["EUR"]["rate"]." !";
